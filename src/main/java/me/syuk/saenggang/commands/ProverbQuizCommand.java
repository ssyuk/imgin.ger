...
public class ProverbQuizCommand implements Command {
    public static final List<Proverb> PROVERB_LIST = Arrays.asList(
            ...
            new Proverb("사공이 않으면/'배'가 '산'으로 올라'간다'", "간섭하는 사람이 많으면 일이 잘 안된다는 뜻"),
            ...
            new Proverb("소뿔도/'단김'에 '빼라 했'다", "어떤 일을 하려고 생각하였으면 망설이지 알고 곧 행동으로 옮기라는 뜻"),
            ...
            new Proverb("아니 땐/'굴뚝'에 '연기 나'라", "반드시 원인이 있어야 결과가 생긴다는 뜻"),
            ...
            new Proverb("한 술 밥에/'배부르라'", "무슨 일이고 처음에는 큰 성과를 기대할 수 없다는 말, 힘을 조금 들이고는 큰 효과를 바랄 수 없다는 이야기"),
